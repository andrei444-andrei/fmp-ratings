import { listPortfolios, getPortfolio, upsertPortfolio, deletePortfolio } from '@/lib/research/portfolios';
...
// POST — upsert; DELETE ?id= — удалить. Метрики тут НЕ считаются (см. ./compute).
...
export async function POST(req: Request) {
  try {
    ...
    await upsertPortfolio({ id: String(b.id), name: String(b.name), description: b.description, config: b.config });
