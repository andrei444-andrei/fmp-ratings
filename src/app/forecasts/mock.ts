...
// real = фактическая годовая total-return бенчмарка (ETF) для скоринга.
// ВНИМАНИЕ: значения округлены до 2 знаков; 2015–2018 и 2025 — приближённые
// исторические оценки (как и старые 2019–2024). Точный пересчёт из FMP
// (dividend-adjusted цены, computeYearly) — отдельным системным шагом.
const RAW: Record<string, Record<number, [number, number | null]>> = {
  US: { 2015: [0.06, 0.01], 2016: [0.06, 0.12], 2017: [0.06, 0.22], 2018: [0.06, -0.05], 2019: [0.07, 0.31], 2020: [0.06, 0.18], 2021: [0.08, 0.29], 2022: [0.05, -0.18], 2023: [0.02, 0.26], 2024: [0.07, 0.25], 2025: [0.06, 0.15] },
  DE: { 2015: [0.05, -0.02], 2016: [0.05, 0.03], 2017: [0.05, 0.27], 2018: [0.05, -0.22], 2019: [0.05, 0.25], 2020: [0.03, 0.04], 2021: [0.07, 0.16], 2022: [-0.03, -0.12], 2023: [0.03, 0.20], 2024: [0.05, 0.18], 2025: [0.05, 0.25] },
  GB: { 2015: [0.04, -0.08], 2016: [0.04, 0.00], 2017: [0.04, 0.22], 2018: [0.04, -0.14], 2019: [0.04, 0.12], 2020: [0.02, -0.14], 2021: [0.05, 0.14], 2022: [0.03, 0.01], 2023: [0.02, 0.04], 2024: [0.04, 0.06], 2025: [0.04, 0.20] },
  JP: { 2015: [0.04, 0.09], 2016: [0.04, 0.02], 2017: [0.04, 0.24], 2018: [0.04, -0.13], 2019: [0.03, 0.18], 2020: [0.02, 0.16], 2021: [-0.01, 0.05], 2022: [-0.02, -0.09], 2023: [0.04, 0.28], 2024: [0.06, 0.19], 2025: [0.04, 0.12] },
  CN: { 2015: [0.06, -0.08], 2016: [0.06, 0.01], 2017: [0.06, 0.54], 2018: [0.06, -0.19], 2019: [0.08, 0.20], 2020: [0.10, 0.27], 2021: [0.09, -0.22], 2022: [0.07, -0.24], 2023: [-0.04, -0.13], 2024: [-0.06, 0.15], 2025: [0.06, 0.30] },
  IN: { 2015: [0.09, -0.06], 2016: [0.09, -0.01], 2017: [0.09, 0.38], 2018: [0.09, -0.08], 2019: [0.09, 0.13], 2020: [0.07, 0.15], 2021: [0.10, 0.24], 2022: [0.08, 0.04], 2023: [0.09, 0.19], 2024: [0.11, 0.12], 2025: [0.09, 0.05] },
  BR: { 2015: [0.06, -0.41], 2016: [0.06, 0.66], 2017: [0.06, 0.24], 2018: [0.06, -0.01], 2019: [0.06, 0.32], 2020: [0.05, 0.03], 2021: [0.08, -0.12], 2022: [0.04, 0.04], 2023: [0.06, 0.22], 2024: [0.07, -0.10], 2025: [0.06, 0.20] },
  PL: { 2015: [0.05, -0.25], 2016: [0.05, 0.00], 2017: [0.05, 0.54], 2018: [0.05, -0.13], 2019: [0.04, null], 2020: [0.03, -0.01], 2021: [0.06, 0.21], 2022: [-0.02, -0.17], 2023: [0.05, 0.36], 2024: [0.05, 0.12], 2025: [0.05, 0.35] },
  KR: { 2015: [0.06, -0.08], 2016: [0.06, 0.09], 2017: [0.06, 0.47], 2018: [0.06, -0.21], 2019: [0.06, 0.09], 2020: [0.05, 0.45], 2021: [0.08, -0.10], 2022: [0.04, -0.29], 2023: [0.07, 0.22], 2024: [0.06, -0.10], 2025: [0.06, 0.20] },
  EU: { 2015: [0.05, -0.02], 2016: [0.05, 0.00], 2017: [0.05, 0.25], 2018: [0.05, -0.15], 2019: [0.05, 0.24], 2020: [0.03, 0.05], 2021: [0.07, 0.16], 2022: [-0.02, -0.15], 2023: [0.04, 0.20], 2024: [0.05, 0.02], 2025: [0.05, 0.22] },
  EM: { 2015: [0.07, -0.16], 2016: [0.07, 0.11], 2017: [0.07, 0.37], 2018: [0.07, -0.15], 2019: [0.07, 0.18], 2020: [0.08, 0.18], 2021: [0.06, -0.03], 2022: [0.05, -0.20], 2023: [0.07, 0.09], 2024: [0.08, 0.08], 2025: [0.07, 0.18] },
  GLD: { 2015: [0.02, -0.11], 2016: [0.02, 0.08], 2017: [0.02, 0.13], 2018: [0.02, -0.02], 2019: [0.02, 0.18], 2020: [0.04, 0.25], 2021: [0.03, -0.04], 2022: [-0.01, -0.01], 2023: [0.02, 0.13], 2024: [0.01, 0.27], 2025: [0.02, 0.45] },
};
