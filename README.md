...
3. **Use-кейсы** (вкладки) над выбранными стратегиями. Готов **«Сравнение по годам»**; в дорожной
   карте — объединённый портфель, сводка по стратегии, риск/корреляция, анализ просадок.
