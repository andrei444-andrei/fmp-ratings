...
**акции по странам** (Япония/Польша/Германия/Великобритания) + свои тикеры) — по умолчанию ничего не
выбрано. «Крупные акции» = **актуальный состав S&P 500**, страновые акции = **топ-N ликвидных по стране**
